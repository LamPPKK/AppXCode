...
class ObjCSymbolIndex {
    ...
    private companion object {
        val TYPE_DECLARATION = Regex("\\b(?:@interface|@implementation|@protocol)\\s+([A-Za-z_][A-Za-z0-9_]*)")
        val METHOD_DECLARATION = Regex("^[+-]\\s*\\([^)]*\\)\\s*([A-Za-z_][A-Za-z0-9_]*)")
    }
}
